...
$(document).on('rails_admin.dom_ready', function() { $("#mcst_council_member_picture, #admin_picture, #mcst_admin_picture, #property_management_company_picture, #property_manager_picture, #service_provider_picture").attr("accept", 'image/png,image/gif,image/jpeg,image/jpg' ) } );
